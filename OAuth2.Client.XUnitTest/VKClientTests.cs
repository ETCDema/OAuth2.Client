...
namespace OAuth2.Client.XUnitTest
{
	...
	public class VKClientTests : ClientTests<VKClientTests.VKService>
	{
			...
			protected override OAuth2Based<UserInfo> CreateClient()
			{
				...
				(
					...
					new TestMessageHandler()
						.Add("[GET]https://oauth.vk.ru/access_token?grant_type=authorization_code&client_id=vk-client-id&client_secret=vk-client-secret&code=code-from-VK&redirect_uri=https%3a%2f%2ftest.host%2foauth2%2fby%2fvk%2f",
						...
						.Add("[POST]https://api.vk.ru/method/users.get",
		...
		protected override string ExpectedLoginURI		=> "https://oauth.vk.ru/authorize?response_type=code&client_id=vk-client-id&redirect_uri=https%3a%2f%2ftest.host%2foauth2%2fby%2fvk%2f";
	}
}
