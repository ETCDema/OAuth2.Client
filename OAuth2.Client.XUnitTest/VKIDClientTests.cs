...
namespace OAuth2.Client.XUnitTest
{
	public class VKIDClientTests : ClientTests<VKIDClientTests.VKIDService>
	{
				...
				(
					...
					new TestMessageHandler()
						.Add("[POST]https://id.vk.ru/oauth2/auth",
							"Headers: [ Accept: application/json\nUser-Agent: RestSharp/107\n ], Body: grant_type=authorization_code&client_id=vk-client-id&code=code-from-VKID&redirect_uri=https%3A%2F%2Ftest.host%2Foauth2%2Fby%2Fvkid%2F&device_id=device-id-from-vk&code_verifier=CAIKWQZBC1ZXQB9dB2tbCUgAW0RRVkcbXgdWEwZZ",
							"application/json",
		...
		protected override string ExpectedLoginURI => "https://id.vk.ru/authorize?response_type=code&client_id=vk-client-id&redirect_uri=https%3a%2f%2ftest.host%2foauth2%2fby%2fvkid%2f&state=State-b39424c6-bec7-4836-b5ac-cee65536e97c&code_challenge=R_p_vp37EQS6kQoVcGiEaI6wOm3OcFxLYy6ebv8OjrM&code_challenge_method=S256";
	}
}
