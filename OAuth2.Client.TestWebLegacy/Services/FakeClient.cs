...
namespace OAuth2.Client.TestWeb.Services
{
	...
	public class FakeClient : OAuth2Based<UserInfo>
	{
		...
		{
			return _client==null ? _client = new RestClient(new RestClientOptions()) : _client;
		}
		...
		/// <inheritdoc/>
		internal override Task<UserInfo> GetUserInfoAsync(NameValueCollection parameters, Action<string, string, string> onReq, string redirectURI = null, CancellationToken cancellationToken = default)
		{
